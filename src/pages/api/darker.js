...
export default function handler(req, res) {
  ...
  const prompt = `Given these 7 hex colors: "${colors}" please provide me colors one shade darker in json formatted like this example: "[{"color": "#F3B289", "description": "A peachy-orange color that might remind you of the color of a beach sunset."}]"`;
